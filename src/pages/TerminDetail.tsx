...
export default function TerminDetail() {
  ...
  const isValidKind: boolean = kind === 'event' || kind === 'session'
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      <header className="flex justify-between items-center mb-6">
        <h1 className="text-xl font-bold">{titel ?? 'Termin'}</h1>
        <Link to="/" className="text-sm text-slate-600 underline">
          Zurück zum Dashboard
        </Link>
      </header>
      ...
      <h2 className="font-semibold mb-2">Notizen &amp; Dokumente</h2>
      ...
      <form onSubmit={handleAddSummary} className="space-y-2 bg-white border rounded p-3 max-w-md">
        <textarea
