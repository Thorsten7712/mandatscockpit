...
import { createDocument, listDocuments, updateDocumentSharing, updateDocumentTags, updateDocumentTitel } from './tools/dokumente.ts'
    ...
    case 'tools/call': {
      ...
      switch (name) {
        ...
        case 'list_documents':
          ...
          break
        case 'update_document_titel':
          result = await updateDocumentTitel(supabase, user.id, args)
          break
